...
// Todas las encuestas
const encuestas = [
  { nombre: "INTERNA PP", fecha: "20 de febrero de 2024", escanos:["PP","PSOE","PP","PSOE","PP","PSOE"] },
  { nombre: "INTERNA PP", fecha: "2 de abril de 2024", escanos:["PP","PSOE","PP","PSOE","PP","PSOE"] },
  { nombre: "ELECTOPANEL", fecha: "30 de agosto de 2024", escanos:["PP","PSOE","PP","PSOE","PP","PSOE"] },
  { nombre: "INTERNA PP", fecha: "3 de noviembre de 2024", escanos:["PP","PSOE","PP","PSOE","PP","PSOE"] },
  { nombre: "INTERNA PP", fecha: "2 de marzo de 2025", escanos:["PP","PSOE","PP","PSOE","PP","PSOE"] },
  { nombre: "SIGMA 2", fecha: "26 de mayo de 2025", escanos:["PSOE","PP","PSOE","PP","PSOE","PP"] },
  { nombre: "ELECTOPANEL", fecha: "30 de septiembre de 2025", escanos:["PP","PSOE","PP","PSOE","PP","PSOE"] },
];
...
function crearGrafico(encuestasFiltradas, idCanvas) {
  ...
  const yLabels = Array.from({length:6}, (_,i)=> (i+1).toString());
