// Colores por partido
const colores = { PP:"#0000FF", PSOE:"#FF0000", VOX:"#008000", PODEMOS:"#800080", SAUNIÓ: "#00A29F" };

// Todas las encuestas
const encuestas = [
   { nombre: "SIGMA 2", fecha: "19 de mayo de 2025", escanos:["PSOE"] },
   { nombre: "IBES", fecha: "1 de junio de 2025", escanos:["PSOE"] },
...
function crearGrafico(encuestasFiltradas, idCanvas) {
  ...
  const yLabels = Array.from({length:1}, (_,i)=> (i+1).toString());
