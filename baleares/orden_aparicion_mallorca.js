// Colores por partido
const colores = { PP:"#0000FF", PSOE:"#FF0000", VOX:"#008000", PODEMOS:"#800080", MÉS: "#CBD046", ELPI: "#71D0B0" };

// Todas las encuestas
const encuestas = [
   { nombre: "SIGMA 2", fecha: "19 de mayo de 2025", escanos:["PP","PSOE","PP","VOX","PSOE","MÉS","PP","PP","PSOE","VOX","PP","PSOE","MÉS","PP","PSOE","PP","VOX","PP","PSOE","MÉS","PP","VOX","PSOE","PP","PSOE","PP","MÉS","VOX","PP","PSOE","PP","PSOE","PP"] },
   { nombre: "IBES", fecha: "1 de junio de 2025", escanos:["PP","PSOE","PP","VOX","PSOE","PP","MÉS","PP","PSOE","VOX","PP","PSOE","PP","MÉS","PP","PSOE","VOX","PP","PSOE","PP","VOX","MÉS","PSOE","PP","PP","PSOE","VOX","PP","PSOE","MÉS","PP","PP","PSOE"] },
...
function crearGrafico(encuestasFiltradas, idCanvas) {
  ...
  const yLabels = Array.from({length:33}, (_,i)=> (i+1).toString());
