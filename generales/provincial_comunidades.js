...
if (provincia === "Extremadura") { 
    const provinciaHtml = `
        <div class="header">
            <h1 style="color: black;">Extremadura <span class="escaños">12 Escaños</span></h1>
<p style="color: black; font-size: 1.2em; text-align: center; font-weight: bold;">
    ...
    <br><br>
    UCD gana las primeras elecciones doblando en escaños al PSOE
    <br><br>
    ...
    <br><br>
    UCD continua como ganador sacando dos escaños de ventaja al PSOE
    <br><br>
...
<p style="color: black; font-size: 1.2em; text-align: center; font-weight: bold;">
    ...
    <br><br>
    El PSOE las vuelve a ganar, sacando un tres escaños de ventaja a AP-PDP-PL
    <br><br>
    ...
    <br><br>
    El PSOE continua en la primera posición sacando tres escaños de ventaja al PP
    <br><br>
                ...
                <br><br>
                El PSOE sigue ganando y sacando tres escaños de ventaja al PP
                <br><br>
...
<br><br>
El PSOE sigue ganando, sacando un escaño de ventaja al PP
<br><br>
...
<br><br>
El PP se coloca como primera fuerza, sacando un escaño de ventaja al PSOE
<br><br>
...
<br><br>
El PSOE vuelve a la primera posición empatando en escaños con el PP
<br><br>
...
<br><br>
El PSOE repite como ganador en la comunidad y empata en escaños con el PP
<br><br>
...
<br><br>
El PP se coloca ganador y saca dos escaños de ventaja al PSOE
<br><br>
...
<br><br>
El PSOE las gana y sumando a PODEMOS sacan dos escaños de ventaja al PP
<br><br>
...
<br><br>
El PSOE gana las elecciones empatando en escaños a la suma de PP, CIUDADANOS y VOX
<br><br>
...
<br><br>
El PSOE sigue ganando empatando en escaños a la suma de PP y VOX. 
<br><br>
...
<br><br>
El PSOE las vuelve a ganar, pero la suma de PP y VOX le saca un escaño de ventaja
<br><br>
...
if (provincia === "Castilla y León") { 
    const provinciaHtml = `
        <div class="header">
            <h1 style="color: black;">Castilla y León <span class="escaños">35 Escaños</span></h1>
<p style="color: black; font-size: 1.2em; text-align: center; font-weight: bold;">
    ...
    <br><br>
    UCD gana las primeras elecciones arrasando y sumando a AP-PDP sacando diecinueve escaños de ventaja al PSOE
    <br><br>
    ...
    <br><br>
    UCD continua como ganador, sacando quince escaños de ventaja al PSOE
    <br><br>
...
<p style="color: black; font-size: 1.2em; text-align: center; font-weight: bold;">
    1986: <a href="https://www.datoselecciones.com/elecciones-generales-congreso-1986/castilla-la-mancha/valladolid" target="_blank" style="font-size: 1.5em; font-weight: bold;">  
        ...
        <span style="color: #ADD8E6;">AP-PDP 14 Escaños</span>
        <span style="color: #006400;">CDS 4 Escaños</span>
        
    </a>
    <br><br>
    El PSOE las vuelve a ganar, pero la suma de AP-PDP y CDS le saca dos escaños de ventaja
    <br><br>
...
<p style="color: black; font-size: 1.2em; text-align: center; font-weight: bold;">
    ...
    <br><br>
    El PP las gana y sumando a CDS sacan cinco escaños de ventaja al PSOE
    <br><br>
        ...
        <span style="color: #FF0000;">PSOE 13 Escaños</span>
                ...
                <br><br>
                El PP sigue ganando, sacando siete escaños de ventaja al PSOE
                <br><br>
...
<br><br>
El PP sigue ganando doblando en escaños al PSOE
<br><br>
...
2000: <a href="https://www.datoselecciones.com/elecciones-generales-congreso-2000/castilla-la-mancha/valladolid" target="_blank" style="font-size: 1.5em; font-weight: bold;">
    <span style="color: #0000FF;">PP 22 Escaños</span>
        <span style="color: #FF0000;">PSOE-PROGR 11 Escaños</span>
</a>
<br><br>
El PP sigue como ganador, doblando en escaños al PSOE
<br><br>
...
<br><br>
El PP continúa como primera fuerza, sacando cinco escaños de ventaja al PSOE
<br><br>
...
<br><br>
El PP repite como ganador en la comunidad, sacando cuatro escaños de ventaja sobre el PSOE
<br><br>
...
<br><br>
El PP sigue ganando sacando diez escaños de ventaja al PSOE
<br><br>
...
<br><br>
El PP vuelve a ganar y sumando a CIUDADANOS sacan ocho escaños de ventaja a la suma de PSOE y PODEMOS.
<br><br>
...
<br><br>
El PP continúa ganando y sumando a CIUDADANOS sacan siete escaños de ventaja a la suma de PSOE y PODEMOS.
<br><br>
...
<br><br>
El PSOE las gana, pero la suma de PP, CIUDADANOS y VOX le saca siete escaños de ventaja.
<br><br>
...
<br><br>
El PP las gana y sumando a VOX sacan siete escaños de ventaja al PSOE
<br><br>
...
<p style="color: black; font-size: 1.2em; text-align: center; font-weight: bold;">
    ...
    <br><br>
    UCD gana las primeras elecciones y sumando el escaño de AP-PDP sacan cinco escaños de ventaja al PSOE
    <br><br>
    ...
    <br><br>
    UCD continua como ganador, sacando cinco escaños de ventaja al PSOE
    <br><br>
    ...
    <br><br>
    El PSOE las gana, sacando un cinco escaños de ventaja a AP-PDP
    <br><br>
    <h1 style="color: black;"><span class="escaños">Pasa a 20 Escaños</span></h1>
<p style="color: black; font-size: 1.2em; text-align: center; font-weight: bold;">
    1986: <a href="https://www.datoselecciones.com/elecciones-generales-congreso-1986/castilla-y-leon/toledo#google_vignette" target="_blank" style="font-size: 1.5em; font-weight: bold;">  
        <span style="color: #FF0000;">PSOE 12 Escaños</span> 
        <span style="color: #ADD8E6;">AP-PDP-PL 8 Escaños</span>
        
        
    </a>
    <br><br>
    El PSOE las vuelve a ganar, sacando cuatro escaños de ventaja a AP-PDP-PL
    <br><br>
    ...
    <br><br>
    El PP las vuelve a ganar, sacando cuatro escaños de ventaja al PP
    <br><br>
        ...
        <span style="color: #0000FF;">PP 10 Escaños</span>
                ...
                <br><br>
                El PSOE sigue ganando empatando en escaños con el PP
                <br><br>
...
2000: <a href="https://www.datoselecciones.com/elecciones-generales-congreso-2000/castilla-y-leon/toledo#google_vignette" target="_blank" style="font-size: 1.5em; font-weight: bold;">
    <span style="color: #0000FF;">PP 12 Escaños</span>
        <span style="color: #FF0000;">PSOE-PROGR 8 Escaños</span>
</a>
<br><br>
El PP sigue como ganador, sacando cuatro escaños de ventaja a PSOE-PROGR
<br><br>
...
<br><br>
El PP continúa como primera fuerza, sacando dos escaños de ventaja al PSOE 
<br><br>
...
<br><br>
El PP repite como ganador en la comunidad sacando dos escaños de ventaja al PSOE
<br><br>
...
<br><br>
Con la mayoria absoluta de Rajoy el PP las gana doblando en escaños al PSOE
<br><br>
...
<br><br>
El PP las vuelve a ganar y sumando a CIUDADANOS sacan cinco escaños de ventaja a la suma de PSOE y PODEMOS
<br><br>
...
<br><br>
El PP las gana sacando tres escaños de ventaja a la suma de PSOE y PODEMOS
<br><br>
...
<br><br>
El PSOE las gana, pero la suma de PP, CIUDADANOS y VOX le saca tres escaños de ventaja
<br><br>
...
<br><br>
El PSOE las vuelve a ganar, pero la suma de PP y VOX le saca tres escaños de ventaja
<br><br>
...
<br><br>
El PP las gana y sumando a VOX sacan cinco escaños de ventaja al PSOE
<br><br>
...
if (provincia === "Aragón") { 
    const provinciaHtml = `
        <div class="header">
            <h1 style="color: black;">Aragón <span class="escaños">14 Escaños</span></h1>
<p style="color: black; font-size: 1.2em; text-align: center; font-weight: bold;">
    ...
    dos escaños de ventaja a la suma de PSOE y PSP-US
    <br><br>
    ...
    UCD las gana y sumando el escaño del PAR sacan cuatro escaños de ventaja al PSOE
    <br><br>
    ...
    <br><br>
    El PSOE las gana, sacando cuatro escaños de ventaja a AP-PDP-PAR.
    <br><br>
    ...
    <br><br>
    El PSOE sigue como vencedor, sacando dos escaños de ventaja a la suma de AP-PDP-PL, PAR y CDS
    <br><br>
    ...
    <br><br>
    El PSOE las gana y sumando el escaño de IU sacan cuatro escaños de ventaja a la suma de PP y PAR
    <br><br>
...
<p style="color: black; font-size: 1.2em; text-align: center; font-weight: bold;">
                ...
                <br><br>
                El PSOE sigue como vencedor y sumando el escaño de IU sacan tres escaños de ventaja a la suma de PP y PAR
                <br><br>
...
<br><br>
El PP-PAR las gana sacando tres escaños de ventaja al PSOE
<br><br>
...
<br><br>
El PP las gana sacando tres escaños de ventaja a la suma de PSOE-PROGR y CHA
<br><br>
...
<br><br>
El PSOE las gana sacando tres escaños de ventaja al PP
<br><br>
...
<br><br>
El PP las gana sacando tres escaños de ventaja a la suma de PSOE y La Izquierda de Aragón: La Izquierda Plural
<br><br>
...
<br><br>
El PP las gana y sumando el escaño de CIUDADANOS sacan un escaño de ventaja a la suma de PSOE y PODEMOS. 
<br><br>
...
<br><br>
El PSOE las gana, pero la suma de CIUDADANOS, PP y VOX le saca un escaño de ventaja a la suma de PSOE y PODEMOS
<br><br>
...
<br><br>
El PSOE las vuelve a ganar y sumando a PODEMOS y ¡TERUEL EXISTE! sacan tres escaños de ventaja a la suma de PP y VOX
<br><br>
...
<br><br>
El PP las gana y sumando a VOX sacan tres escaños de ventaja a la suma de PSOE y SUMAR.
<br><br>
...
if (provincia === "Euskadi") { 
    const provinciaHtml = `
        <div class="header">
            <h1 style="color: black;">Euskadi <span class="escaños">21 Escaños</span></h1>
<p style="color: black; font-size: 1.2em; text-align: center; font-weight: bold;">
    ...
    <br><br>
    El PNV gana las primeras elecciones y sumando al PSE-PSOE y EE sacan once escaños de ventaja a la suma de UCD y AP
    <br><br>
    ...
    <br><br>
    El PNV continúa como ganador y junto con el PSE, HB y EE sacan once escaños de ventaja a UCD
    <br><br>
    1982: <a href="https://www.datoselecciones.com/elecciones-generales-congreso-1982/pais-vasco/bizkaia" target="_blank" style="font-size: 1.5em; font-weight: bold;">
        <span style="color: #298242;">PNV 8 Escaños</span>
        <span style="color: #FF0000;">PSE-PSOE 8 Escaños</span>
    ...
    <br><br>
    El PNV las gana y sumando al PSE, HB y EE sacan diecisiete escaños de ventaja a AP-PDP-PL.
    <br><br>
    ...
    <br><br>
    El PSE-PSOE las gana y sumando al PNV, HB y EE sacan diecisiete escaños de ventaja a AP-PDP-PL
    <br><br>
    ...
    <br><br>
    El PSE-PSOE las sigue ganando y sumando al PNV, HB, EA y EE sacan diecisiete escaños de ventaja al PP
...
<p style="color: black; font-size: 1.2em; text-align: center; font-weight: bold;">
        ...
        <span style="color: #01b59c;">HB 2 Escaños</span>
         <span style="color: #298242;">EUSKO ALKARTASUNA-EUE 1 Escaño</span>
                ...
                <br><br>
                El PSE-PSOE sigue en la primera posición y sumando al PNV, HB y EA-EUE sacan once escaños de ventaja al PP
                <br><br>
...
<br><br>
El PNV las gana y sumando al PSE-PSOE, HB, IU-EB y EA sacan nueve escaños de ventaja al PP
<br><br>
...
<br><br>
El PNV las gana y sumando al PSE-PSOE y EA sacan cinco escaños de ventaja al PP
<br><br>
...
<br><br>
El PNV las gana y sumando al PSE-PSOE y EA sacan once escaños de ventaja al PP
<br><br>
...
<br><br>
El PSE las gana por primera vez en las únicas elecciones generales en las que el pais se tiñe de azul y rojo sin presencia vencedora de regionalismos o independentismos debido a la polarización y sumando al PNV quintuplican en escaños al PP. 
<br><br>
...
<br><br>
AMAIUR las gana y sumando al PNV y al PSE-PSOE quintuplican en escaños al PP
<br><br>
...
<br><br>
El PNV sigue como vencedor y sumando a PODEMOS, PSE y EHBILDU multiplican por ocho en escaños al PP
<br><br>
...
<br><br>
PODEMOS las gana y sumando al PNV, PSE y EHBILDU multiplican por ocho en escaños al PP
<br><br>
...
<br><br>
El PNV vuelve a la primera posición y saca dos escaños de ventaja tanto al PSE como a PODEMOS y EHBILDU. 
<br><br>
...
<br><br>
El PNV sigue ganando y sumando al PSE, PODEMOS y EHBILDU sacan dieciseis escaños de ventaja al PP. 
<br><br>
...
<br><br>
El PSE-PSOE las gana y sumando al PNV, EHBILDU y SUMAR multiplican por ocho en escaños al PP. 
<br><br>
...
if (provincia === "Canarias") { 
    const provinciaHtml = `
        <div class="header">
            <h1 style="color: black;">Canarias <span class="escaños">13 Escaños</span></h1>
<p style="color: black; font-size: 1.2em; text-align: center; font-weight: bold;">
    1977: <a href="https://www.datoselecciones.com/elecciones-generales-congreso-1977/canarias/las-palmas" target="_blank" style="font-size: 1.5em; font-weight: bold;"> 
        <span style="color: #FFA500;">UCD 10 Escaños</span>
        <span style="color: #FF0000;">PSOE 3 Escaños</span>
    </a>
    <br><br>
    UCD gana las primeras elecciones sacando siete escaños de ventaja al PSOE
    <br><br>
    ...
    <br><br>
    UCD las vuelve a ganar y saca cinco escaños de ventaja a la suma de PSOE y C-UPC (Unión del Pueblo Canario (UPC) fue una coalición de partidos políticos comunistas, independentistas y nacionalistas de izquierdas de Canarias que existió entre finales de los años 70 y principios de los 80.). 
    <br><br>
...
<p style="color: black; font-size: 1.2em; text-align: center; font-weight: bold;">
    ...
    <br><br>
    El PSOE las gana empatando en escaños a la suma de PP, CDS y AIC
    <br><br>
                ...
                <br><br>
                El PP las gana y sumando a CCA sacan cuatro escaños de ventaja al PSOE
                <br><br>
...
<br><br>
El PP las vuelve a ganar y sumando a CCA sacan cuatro escaños de ventaja al PSOE. 
<br><br>
...
<br><br>
El PP las gana y sumando a CCA sacan ocho escaños de ventaja al PSOE-PROGR.
<br><br>
...
<br><br>
El PSOE las gana, pero la suma de PP y CCA-PNC le saca un escaño de ventaja
<br><br>
...
<br><br>
Con la mayoría absoluta de Rajoy el PP las gana y sumando a CCA-NC-PNC sacan siete escaños de ventaja al PSOE
<br><br>
...
<br><br>
El PP las gana y sumando a CIUDADANOS y CCA-PNC sacan un escaño de ventaja a la suma de PSOE-NC y PODEMOS 
<br><br>
...
<br><br>
El PP las gana y sumando a CIUDADANOS y CCA-PNC sacan tres escaños de ventaja a la suma de PSOE-NC y PODEMOS
<br><br>
...
<br><br>
El PSOE las gana y sumando a PODEMOS sacando un escaño de ventaja a la suma de PP, CIUDADANOS y CCA-PNC
<br><br>
...
<br><br>
El PSOE las vuelve a ganar, pero la suma de PP, CCA-NC-PNC y VOX le saca un escaño de ventaja a la suma de PSOE y PODEMOS 
<br><br>
...
<br><br>
El PSOE las gana, pero la suma de PP, CCA y VOX le saca un escaño de ventaja a la suma de PSOE y SUMAR
<br><br>
...
if (provincia === "Galicia") { 
    const provinciaHtml = `
        <div class="header">
            <h1 style="color: black;">Galicia <span class="escaños">27 Escaños</span></h1>
<p style="color: black; font-size: 1.2em; text-align: center; font-weight: bold;">
    ...
    <br><br>
    UCD gana las primeras elecciones arrasando y sumando a AP multiplican por ocho en escaños al PSOE
    <br><br>
    ...
    <br><br>
    AP-PDP las gana y sumando a UCD doblan en escaños al PSOE
    <br><br>
    1986: <a href="https://www.datoselecciones.com/elecciones-generales-congreso-1986/galicia/a-coruna" target="_blank" style="font-size: 1.5em; font-weight: bold;">  
        <span style="color: #ADD8E6;">AP-PDP-PL-C 13 Escaños</span> 
        <span style="color: #FF0000;">PSOE 11 Escaños</span> 
        <span style="color: #006400;">CDS 2 Escaños</span>
        <span style="color: #FFA500;">CG 1 Escaño</span>
    </a>
    <br><br>
    AP-PDP-PL-C las gana y sumando a CDS y CG sacan cinco escaños de ventaja al PSOE
    <br><br>
    ...
    <br><br>
    El PP las gana y sumando el escaño de CDS sacan tres escaños de ventaja al PSOE
    <br><br>
    <h1 style="color: black;"><span class="escaños">Pasa a 26 Escaños</span></h1>
<p style="color: black; font-size: 1.2em; text-align: center; font-weight: bold;">
                ...
                <br><br>
                El PP las gana sacando cuatro escaños de ventaja al PSOE
                <br><br>
...
<br><br>
El PP las vuelve a ganar, pero la suma de PSOE y BNG le saca un escaño de ventaja
<br><br>
...
<br><br>
Con la mayoria absoluta de Rajoy el PP las gana sacando siete escaños de ventaja a la suma de PSOE y BNG
<br><br>
...
<br><br>
El PP las gana, pero la suma de PODEMOS y PSOE le saca un escaño de ventaja a la suma de PP y CIUDADANOS
<br><br>
...
<br><br>
El PP las vuelve a ganar sacando un escaño de ventaja a la suma de PSOE y PODEMOS
<br><br>
...
<br><br>
El PSOE las gana y sumando a PODEMOS sacan un escaño de ventaja a la suma de PP y CIUDADANOS
<br><br>
...
<br><br>
El PP las gana, pero la suma de PSOE, PODEMOS y BNG le saca tres escaños de ventaja.
<br><br>
...
<br><br>
El PP las gana sacando tres escaños de ventaja a la suma de PSOE, SUMAR y BNG 
<br><br>
...
if (provincia === "Andalucía") { 
    const provinciaHtml = `
        <div class="header">
            <h1 style="color: black;">Andalucía <span class="escaños">59 Escaños</span></h1>
<p style="color: black; font-size: 1.2em; text-align: center; font-weight: bold;">
    ...
    <br><br>
    El PSOE gana las primeras elecciones y sumando al PCE y PSP-US sacan siete escaños de ventaja a UCD
    <br><br>
    ...
    1982: <a href="https://www.datoselecciones.com/elecciones-generales-congreso-1982/andalucia/sevilla" target="_blank" style="font-size: 1.5em; font-weight: bold;">
        <span style="color: #FF0000;">PSA-PSOE 43 Escaños</span> 
        <span style="color: #ADD8E6;">AP-PDP 15 Escaños</span> 
        <span style="color: #FF0D00;">PCA-PCE 1 Escaño</span> 
          
    </a>
    <br><br>
    El PSA-PSOE las gana y sumando a PCA-PCE sacan veintinueve escaños de ventaja a AP-PDP 
    <br><br>
    <h1 style="color: black;"><span class="escaños">Pasa a 60 Escaños</span></h1>
<p style="color: black; font-size: 1.2em; text-align: center; font-weight: bold;">
    ...
    <br><br>
    El PSOE sigue como vencedor y sumando a IU triplican en escaños a AP-PDP-PL. 
    <br><br>
...
<p style="color: black; font-size: 1.2em; text-align: center; font-weight: bold;">
    ...
    <br><br>
                ...
                <br><br>
                El PSOE sigue ganando y sumando a IU-CA sacan veintiun escaños de ventaja al PP
                <br><br>
                <h1 style="color: black;"><span class="escaños">Pasa a 62 Escaños</span></h1>
<p style="color: black; font-size: 1.2em; text-align: center; font-weight: bold;">
...
<br><br>
El PSOE sigue como vencedor y sumando a IU-CA sacan catorce escaños de ventaja al PP 
<br><br>
...
2000: <a href="https://www.datoselecciones.com/elecciones-generales-congreso-2000/andalucia/sevilla" target="_blank" style="font-size: 1.5em; font-weight: bold;">
        <span style="color: #FF0000;">PSOE-PROGR 30 Escaños</span>
...
<br><br>
PSOE-PROGR las gana y sumando a IU-CA y PA sacan seis escaños de ventaja al PP. 
<br><br>
 <h1 style="color: black;"><span class="escaños">Pasa a 61 Escaños</span></h1>
<p style="color: black; font-size: 1.2em; text-align: center; font-weight: bold;">
...
<br><br>
El PSOE las gana sacando quince escaños de ventaja al PP
<br><br>
...
<br><br>
El PSOE repite como ganador en la comunidad sacando once escaños de ventaja al PP
<br><br>
 <h1 style="color: black;"><span class="escaños">Pasa a 60 Escaños</span></h1>
<p style="color: black; font-size: 1.2em; text-align: center; font-weight: bold;">
...
<br><br>
El PP las gana sacando seis escaños de ventaja a la suma de PSOE e IU-CA
<br><br>
 <h1 style="color: black;"><span class="escaños">Pasa a 61 Escaños</span></h1>
<p style="color: black; font-size: 1.2em; text-align: center; font-weight: bold;">
...
<br><br>
El PSOE las gana y sumando a PODEMOS sacan tres escaños de ventaja a la suma de PP y CIUDADANOS.
<br><br>
...
<br><br0>
El PP las gana, pero la suma de PSOE y PODEMOS le saca un escaño de ventaja a la suma de PP y CIUDADANOS
<br><br>
...
<br><br>
El PSOE las gana con enorme ventaja y sumando a PODEMOS sacan cinco escaños de ventaja a la suma de CIUDADANOS, PP y VOX.
<br><br>
...
<br><br>
El PSOE las vuelve a ganar y sumando a PODEMOS sacan un escaño de ventaja a la suma de PP, VOX y CIUDADANOS.
<br><br>
...
<br><br>
El PP las gana y sumando a VOX sacan siete escaños de ventaja a la suma de PSOE y SUMAR
<br><br>
...
if (provincia === "Comunidad Valenciana") { 
    const provinciaHtml = `
        <div class="header">
            <h1 style="color: black;">Comunidad Valenciana <span class="escaños">29 Escaños</span></h1>
<p style="color: black; font-size: 1.2em; text-align: center; font-weight: bold;">
    ...
    <br><br>
    El PSOE gana las primeras elecciones y sumando al PCE y PSP-US sacan tres escaños de ventaja a la suma de UCD y AP e INDEP.
    <br><br>
    ...
    1982: <a href="https://www.datoselecciones.com/elecciones-generales-congreso-1982/comunidad-valenciana/valencia" target="_blank" style="font-size: 1.5em; font-weight: bold;">
        ...
        <span style="color: #ADD8E6;">AP-PDP-UV 10 Escaños</span> 
          
    </a>
    <br><br>
    El PSOE las gana doblando aacando nueve escaños de ventaja a AP-PDP-UV
    <br><br>
    <h1 style="color: black;"><span class="escaños">Pasa a 31 Escaños</span></h1>
<p style="color: black; font-size: 1.2em; text-align: center; font-weight: bold;">
    1986: <a href="https://www.datoselecciones.com/elecciones-generales-congreso-1986/comunidad-valenciana/valencia" target="_blank" style="font-size: 1.5em; font-weight: bold;">  
        <span style="color: #FF0000;">PSOE 18 Escaños</span> 
        <span style="color: #ADD8E6;">AP-PDP-PL 10 Escaños</span> 
        <span style="color: #006400;">CDS 2 Escaños</span>
    ...
    <br><br>
    El PSOE las vuelve a ganar y sumando a IU-EU sacan cinco escaños de ventaja a la suma de PP, CDS y UV
    <br><br>
...
<br><br>
El PP las gana y sumando a UV empatan en escaños a la suma del PSOE y EU-PV.
<br><br>
...
<br><br>
El PP sigue como ganador, sacando seis escaños de ventaja a la suma de PSOE-PROGR y EU-PV.
<br><br>
...
<br><br>
El PP continúa como primera fuerza sacando dos escaños de ventaja a la suma de PSOE y ENTESA (Coalición que formaron Esquerra Unida del País Valencià, Izquierda Republicana y el sector de Els Verds partidario de Carles Arnal constituido en un nuevo partido, Els Verds Esquerra Ecologista del País Valencià.).
<br><br>
<h1 style="color: black;"><span class="escaños">Pasa a 33 Escaños</span></h1>
<p style="color: black; font-size: 1.2em; text-align: center; font-weight: bold;">
...
<br><br>
El PP repite como ganador en la comunidad sacando cinco escaños de ventaja al PSOE
<br><br>
...
<br><br>
Con la mayoría absoluta de Rajoy, el PP sigue ganando y sumando a UPYD sacan nueve escaños de ventaja a la suma de PSOE, EU-PV-EV y COMPROMIS.
<br><br>
<h1 style="color: black;"><span class="escaños">Pasa a 32 Escaños</span></h1>
<p style="color: black; font-size: 1.2em; text-align: center; font-weight: bold;">
...
<br><br>
El PP vuelve a ganar y sumando a CIUDADANOS empatan en escaños a la suma de PODEMOS-COMPROMIS y PSOE
<br><br>
<h1 style="color: black;"><span class="escaños">Pasa a 33 Escaños</span></h1>
<p style="color: black; font-size: 1.2em; text-align: center; font-weight: bold;">
...
<br><br>
El PP continúa ganando y sumando a CIUDADANOS sacan tres escaños de ventaja a la suma de PODEMOS-COMPROMIS-EUPV y PSOE.
<br><br>
<h1 style="color: black;"><span class="escaños">Pasa a 32 Escaños</span></h1>
<p style="color: black; font-size: 1.2em; text-align: center; font-weight: bold;">
...
<br><br>
El PSOE las gana y sumando a PODEMOS y COMPROMIS empatan en escaños a la suma de PP, CIUDADANOS y VOX
<br><br>
...
<br><br>
El PSOE las gana, pero la suma de PP, VOX y CIUDADANOS le saca dos escaños der ventaja a la suma de PSOE, PODEMOS y COMPROMIS
<br><br>
<h1 style="color: black;"><span class="escaños">Pasa a 33 Escaños</span></h1>
<p style="color: black; font-size: 1.2em; text-align: center; font-weight: bold;">
...
if (provincia === "Cataluña") { 
    const provinciaHtml = `
        <div class="header">
            <h1 style="color: black;">Barcelona <span class="escaños">47 Escaños</span></h1>
<p style="color: black; font-size: 1.2em; text-align: center; font-weight: bold;">
    1977: <a href="https://www.datoselecciones.com/elecciones-generales-congreso-1977/catalunya/barcelona" target="_blank" style="font-size: 1.5em; font-weight: bold;">
        <span style="color: #FF0000;">PSC-PSOE 15 Escaños</span> 
...
Catalanismo)
    ...
    <br><br>
    El PSC-PSOE las gana y sumando a CIU, PSUC y ERC sacan treinta y dos escaños de ventaja a AP-PDP
    <br><br>
    ...
    <br><br>
    El PSC continúa como ganador y sumando a CIU y PSUC-ENE sacan cuarenta escaños de ventaja a la suma de AP-PDP-PL y CDS
    <br><br>
    <h1 style="color: black;"><span class="escaños">Pasa a 46 Escaños</span></h1>
<p style="color: black; font-size: 1.2em; text-align: center; font-weight: bold;">
    ...
    <br><br>
    El PSC continúa como ganador en la comunidad y sumando a CIU e IC sacan treinta y seis escaños de ventaja a la suma de PP y CDS.
    <br><br>
...
<p style="color: black; font-size: 1.2em; text-align: center; font-weight: bold;">
        ...
        <span style="color: #c99f00;">ERC 1 Escaño</span>
                ...
                <br><br>
                El PSC las gana y sumando a CIU, IC y ERC sacan treinta y nueve escaños de ventaja al PP.
                <br><br>
                <h1 style="color: black;"><span class="escaños">Pasa a 46 Escaños</span></h1>
<p style="color: black; font-size: 1.2em; text-align: center; font-weight: bold;">
...
<br><br>
El PSC las gana y sumando a CIU, IC-EV y ERC sacan treinta y nueve escaños de ventaja al PP. 
<br><br>
...
<br><br>
El PSC repite como fuerza ganadora y sumando a CIU, ERC e IC-EV sacan treinta y cuatro escaños de ventaja al PP.
<br><br>
<h1 style="color: black;"><span class="escaños">Pasa a 47 Escaños</span></h1>
<p style="color: black; font-size: 1.2em; text-align: center; font-weight: bold;">
...
<br><br>
El PSC las gana y sumando a CIU, ERC e IC-EV sacan cuarenta y un escaños de ventaja al PP.   
<br><br>
...
<br><br>
El PSC sigue ganando y sumando a CIU, ERC e IC-EV sacan treinta y nueve escaños de ventaja al PP.
<br><br>
...
<br><br>
CIU las gana y sumando a PSC, IC-EV y ERC sacan treinta y seis escaños de ventaja al PP.
<br><br>
...
<br><br>
Reconfiguración total de Cataluña: PODEMOS las gana y sumando a ERC CATSÍ, el PSC-PSOE y DL sacan treinta y siete escaños de ventaja a la suma de CIUDADANOS y PP.
<br><br>
...
2016: <a href="https://resultados.elpais.com/elecciones/2016/generales/congreso/09/08.html" target="_blank" style="font-size: 1.5em; font-weight: bold;">
    ...
    <span style="color: #FF0000;">PSC-PSOE 7 Escaños</span>
    <span style="color: #0000FF;">PP 6 Escaños</span> 
    <span style="color: #FF7F00;">CS 5 Escaños</span>

</a>
<br><br>
PODEMOS las sigue ganando y sumando a ERC CATSÍ, CDC y el PSC-PSOE sacan treinta y seis escaños de ventaja a la suma de PP y CIUDADANOS. 
<br><br>
<h1 style="color: black;"><span class="escaños">Pasa a 48 Escaños</span></h1>
<p style="color: black; font-size: 1.2em; text-align: center; font-weight: bold;">
...
<br><br>
ERC SOBERANISTES las gana y sumando a PSC-PSOE, PODEMOS y JUNTS sacan cuarenta y un escaños de ventaja a la suma de CIUDADANOS, PP y VOX.
<br><br>
...
<br><br>
ERC SOBERANISTES sigue ganando y sumando al PSC-PSOE, JUNTS, PODEMOS y la CUP sacan cuarenta y un escaños de ventaja a la suma de PP, VOX y CIUDADANOS.
<br><br>
...
<br><br>
El PSC las gana con enorme ventaja y sumando a SUMAR, ERC y JUNTS sacan cuarenta escaños de ventaja a la suma de PP y VOX.
<br><br>
