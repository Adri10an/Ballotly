...
// Todas las encuestas
const encuestas = [
  { nombre: "EM ANALYTICS", fecha: "28 de mayo de 2024", escanos:["PSOE","CCA","PP","PSOE","CCA","PSOE","CCA","PP"] }, 
 { nombre: "ÁGORA INTEGRAL", fecha: "30 de mayo de 2025", escanos:["CCA","PSOE","PP","CCA","PSOE","CCA","PP","PSOE"] }, 
  { nombre: "SIGMA 2", fecha: "31 de mayo de 2025", escanos:["CCA","PSOE","PP","CCA","PSOE","CCA","NC","PP"] }, 
  { nombre: "OEI", fecha: "14 de enero de 2026", escanos:["CCA","PSOE","PP","CCA","PSOE","CCA","NC","PSOE"] }, 
];
...
function crearGrafico(encuestasFiltradas, idCanvas) {
  ...
  const yLabels = Array.from({length:8}, (_,i)=> (i+1).toString());
