// Colores por partido
const colores = { PP:"#0000FF", PSOE:"#FF0000", VOX:"#6ae80d",ASAMBLEAHERREÑA: "#BCCE44", AHÍ: "#018001"};

// Todas las encuestas
const encuestas = [
  { nombre: "EM ANALYTICS", fecha: "28 de mayo de 2024", escanos:["AHÍ","PP","PSOE"] }, 
  { nombre: "ÁGORA INTEGRAL", fecha: "30 de mayo de 2025", escanos:["AHÍ","PP","PSOE"] }, 
  { nombre: "SIGMA 2", fecha: "31 de mayo de 2025", escanos:["AHÍ","PP","PSOE"] }, 
  { nombre: "OEI", fecha: "14 de enero de 2026", escanos:["AHÍ","PSOE","PP"] }, 
];
...
function crearGrafico(encuestasFiltradas, idCanvas) {
  ...
  const yLabels = Array.from({length:3}, (_,i)=> (i+1).toString());
