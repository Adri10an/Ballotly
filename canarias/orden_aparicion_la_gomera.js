// Colores por partido
const colores = { PP:"#0000FF", PSOE:"#FF0000", VOX:"#008000", ASG: "#BF5B5B"};

// Todas las encuestas
const encuestas = [
{ nombre: "EM ANALYTICS", fecha: "28 de mayo de 2024", escanos:["ASG","ASG","ASG","PSOE"] }, 
{ nombre: "ÁGORA INTEGRAL", fecha: "30 de mayo de 2025", escanos:["ASG","ASG","ASG","PSOE"] },  
{ nombre: "SIGMA 2", fecha: "31 de mayo de 2025", escanos:["ASG","ASG","ASG","PSOE"] }, 
{ nombre: "OEI", fecha: "14 de enero de 2026", escanos:["ASG","ASG","ASG","PSOE"] }, 
...
function crearGrafico(encuestasFiltradas, idCanvas) {
  ...
  const yLabels = Array.from({length:4}, (_,i)=> (i+1).toString());
