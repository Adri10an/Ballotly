 ...
 // ================= PP Palencia =================
const datosPPPalencia = [47.26, 45.70, 46.03, 53.52, 52.72, 49.88, 49.24, 53.04, 41.01, 34.50, 32.95,35.64];
...
// ================= PSOE Palencia =================
const datosPSEPalencia = [41.36, 33.87, 37.79, 32.67, 39.00, 42.63, 40.24, 32.78, 29.03, 35.90, 33.96,34.18];
...
// ================= VOX Palencia =================
const datosVOXPalencia = [5.69, 18.04,20.43];
...
new Chart(ctxVOXPalencia, {
  ...
  plugins: [
   ...
   // ================= CS Palencia =================
const datosCSPalencia = [9.92, 15.09, 5.48];
...
new Chart(ctxCSPalencia, {
  ...
  plugins: [
   ...
   // ================= PODEMOS/IU Palencia =================
const datosPodemosPalencia = [10.80, 4.58, 4.31,0.58];
...
// ================= CDS Palencia =================
const datosCDSPalencia = [4.92, 13.89, 6.83];
...
new Chart(ctxCDSPalencia, {
  ...
  plugins: [
   ...
   // ================= IU Segovia =================
const datosIUSegovia = [4.35, 5.42, 8.63, 6.01, 3.32, 2.50, 4.41, 3.86, 2.10, 4.31,1.94];
...
// ================= UPyD Palencia =================
const datosUPyDPalencia = [2.4, 1.15];
...
const etiquetasPalencia = ['1983','1987','1991','1995','1999','2003','2007','2011','2015','2019','2022','2026'];

const datosPalenciaPct = {
  'PP':           [47.26, 45.70, 46.03, 53.52, 52.72, 49.88, 49.24, 53.04, 41.01, 34.50, 32.95,35.64],
  'PSOE':         [41.36, 33.87, 37.79, 32.67, 39.00, 42.63, 40.24, 32.78, 29.03, 35.90, 33.96,34.18],
  'VOX':          [null,null,null,null,null,null,null,null,null,5.69,18.04,20.43],
  'CS':           [null,null,null,null,null,null,null,null,9.92,15.09,5.48],
  'Podemos/IU':   [null,null,null,null,null,null,null,null,10.80,4.58,4.31,0.58],
  'CDS':          [4.92, 13.89, 6.83,null,null,null,null,null,null,null,null],
  'IU':           [null,4.35,5.42,8.63,6.01,3.32,2.50,4.41,3.86,2.10,4.31,1.94],
  'UPyD':         [null,null,null,null,null,null,null,2.4,1.15,null,null,null],
  'SALF':         [null,null,null,null,null,null,null,null,null,null,null,1.62],
};
...
const datasetsPalenciaPct = Object.keys(datosPalenciaPct).map(partido => ({
  type: 'line',
  label: partido,
  data: datosPalenciaPct[partido],
...
const ctxPalenciaPct = document.getElementById('palenciaPctChart').getContext('2d');

new Chart(ctxPalenciaPct, {
  data: {
    labels: etiquetasPalencia,
    datasets: datasetsPalenciaPct
  },
  options: {
    responsive: true,
    plugins: {
